import { FaRegComment, FaRegBookmark, FaTrash } from "react-icons/fa";
import { BiRepost, BiUpvote } from "react-icons/bi";
  ...
  const { mutate: likePost, isPending: isLinking } = useMutation({
    ...
    onSuccess: (updateLikes) => {
      ...
      queryClient.setQueryData(["posts"], (oldData) =>
        oldData.map((p) => (p._id === post._id ? { ...p, likes: updateLikes } : p))
      );
    },
    onError: (error) => {
